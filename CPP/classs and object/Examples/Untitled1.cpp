		...
		void asscending_order_accno(int book_count,Library *l)
		{
			...
			for(int i = 0;i<book_count;i++)
			{
				for(int j = i+1; j<book_count;j++)
				{
					...
					{
//						int temp_accno = (l+i)->acce_no;
//						(l+i)->acce_no = (l+j)->acce_no;
//						(l+j)->acce_no = temp_accno;
//						
//						char temp_title[90];
//						strcpy(temp_title,(l+i)->book_title);
//						strcpy((l+i)->book_title,(l+j)->book_title);
//						strcpy((l+j)->book_title,temp_title);
//						
//						char temp_author[90];
//						strcpy(temp_author,(l+i)->author_name);
//						strcpy((l+i)->author_name,(l+j)->author_name);
//						strcpy((l+j)->author_name,temp_author);						
//						
//						int temp_price = (l+i)->book_price;
//						(l+i)->book_price = (l+j)->book_price;
//						(l+j)->book_price = temp_price;
...
//					cout<<l[i].GetAccessionNumber()<<"\t";
//					cout<<l[i].GetTitle()<<"\t";
//					cout<<l[i].GetAuthorName()<<"\t";
//					cout<<l[i].GetPrice()<<"\n";
